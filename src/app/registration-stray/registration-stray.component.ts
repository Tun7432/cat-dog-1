...
@Component({
  selector: 'app-registration-stray',
  standalone: true,
  imports: [RouterLink, CommonModule, FormsModule],
  templateUrl: './registration-stray.component.html',
  styleUrls: ['./registration-stray.component.scss']
})
export class RegistrationStrayComponent implements OnInit {
  provinces: any[] = [];
  amphures: any[] = [];
  tambons: any[] = [];
