...
@Component({
  selector: 'app-history-informer',
  standalone: true,
  imports: [RouterLink, CommonModule, FormsModule],
  templateUrl: './history-informer.component.html',
  styleUrls: ['./history-informer.component.scss']
})
export class HistoryInformerComponent implements OnInit {
  provinces: any[] = [];
  amphures: any[] = [];
  tambons: any[] = [];
